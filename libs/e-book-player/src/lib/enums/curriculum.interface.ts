import { GradeLevelType } from './grade-level-type';
import {
  ApiSubject,
  ApiDivision,
  ApiGrade,
  ...
  ApiResource,
  ApiEbook
} from './curriculum-api.interface';
import { ResourceType } from './resource-type.enum';
import { ResourceRequestType } from './resource-request-type.enum';
import { TopicStatus } from './topic-status.enum';
import { ComponentRef } from '@angular/core';
import { CurriculumUtils } from '../utils/curriculum.utils';
import { FilterResourceType } from './filter-resource-type.enum';
...
export class Ebook {
  ...
  private constructChapterData(ebookJson) {
    console.log("constructChapterData--->ebookJson",ebookJson)
